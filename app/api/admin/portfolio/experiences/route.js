...
const mapper = (body, sortOrder) => ({
  ...
  color: (body.color || 'from-blue-500 to-cyan-400').trim(),
  ...(sortOrder !== undefined && { sortOrder }),
});

const { GET, POST } = createListHandlers('experience', required, mapper);
const { PATCH } = createReorderHandler('experience');
